...
class CommunityPost(Base):
    ...
    community_score_id: Mapped[str] = mapped_column(String(64), nullable=False)
    score_id: Mapped[str] = mapped_column(String(64), nullable=False)
    title: Mapped[str] = mapped_column(String(255), nullable=False)
    author_name: Mapped[str] = mapped_column(String(100), default="社区用户", nullable=False)
