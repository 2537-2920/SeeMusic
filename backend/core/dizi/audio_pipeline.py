"""Audio-to-dizi jianpu pipeline."""

from __future__ import annotations

from typing import Any

from backend.core.dizi.notation import generate_dizi_score_from_pitch_sequence, normalize_flute_type
...
def generate_dizi_score_from_audio(
    *,
    file_name: str,
    audio_bytes: bytes,
    analysis_id: str,
    ...
    score = generate_dizi_score_from_pitch_sequence(
